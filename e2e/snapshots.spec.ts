 ...
 *
 * dcyfr.app is a product / template showcase. Two views:
 * - `/` home (hero + stats + template grid + integration matrix)
 * - `/#templates` anchor-scroll to templates section
 */
...
const ROUTES = [
  { path: '/', name: 'home' },
  { path: '/#templates', name: 'templates-anchor' },
] as const;
